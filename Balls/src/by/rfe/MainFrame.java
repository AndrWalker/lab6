...
JMenu controlMenu1 = new JMenu("Стоп");
Action pauseAction1 = new AbstractAction("Стоп"){
public void actionPerformed(ActionEvent event) {
			field.pause1();
}
};
Action pauseAction2 = new AbstractAction("Старт"){
public void actionPerformed(ActionEvent event) {
	field.resume1();
}
};
menuBar.add(controlMenu1);
controlMenu1.add(pauseAction1);
controlMenu1.add(pauseAction2);
